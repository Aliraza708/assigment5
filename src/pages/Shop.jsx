...
function Shop() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <ShopBanner />
      <div id="filter-bar" className="bg-[#f8f1e7] flex justify-around items-center h-20 w-full">
        <div className="flex justify-center gap-7 w-3/4 items-center">
          ...
          <div className="font-poppins text-center text-lg font-normal" style={{ borderLeft: '2px solid black', height: '30px', paddingLeft: '18px' }}>
            Showing {startIndex > 32 ? startIndex=32 : startIndex}–{endIndex > 32 ? 32 : endIndex } of 32 results
          </div>
        </div>
        ...
        <div className="flex justify-end mr-7 gap-6 w-2/3">
          <div className="flex justify-between w-28 items-center">
            ...
            <div className="bg-white h-14 w-14 text-center pt-4 text-xl font-poppins font-normal">
              <select  className="border-none outline-none w-12 text-center appearance-none  custom-select " name="" onChange={(e)=>setproductsPerPage(e.target.value)}>
      ...
      <div className="mt-9">
         {startIndex == 32 &&   <div className="flex justify-center  h-96 text-2xl items-center">
       Product No More
    </div>  }
      ...
      <div className="flex justify-center mt-8 items-center">
        ...
        defaultCurrent={1}
        onChange={(num)=>handleChange(num)}
        total={productsPerPage === "16" ? 20 : 32  }
        className="flex"
        showPrevNextJumpers={false}
        itemRender={(page, type, originalElement) => {
          if (type === 'prev') {
